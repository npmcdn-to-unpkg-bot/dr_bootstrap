  ...
  if($(this).val()) {
	...
	$(".office-wrapper, .headquarters-wrapper").on("mouseenter",function(){
		...
		if($(document).width() >= 950){
	    	...
	    	if($thisOffice == "beijing"){
	    		var adjustedX = parseFloat(x)+39;
	    		var adjustedY = parseFloat(y)-9;
	    	}else if($thisOffice == "shanghai"){
	    	...
	    	}else if($thisOffice == "victoria"){
	    		var adjustedX = parseFloat(x)-136;
	    		var adjustedY = parseFloat(y)-20;
	    	}else if($thisOffice == "kaysville"){
	    		var adjustedX = parseFloat(x)-123;
	    		var adjustedY = parseFloat(y)-13;
	    	}else if($thisOffice == "sanDiego"){
	    		var adjustedX = parseFloat(x)-128;
	    		var adjustedY = parseFloat(y)-2;
        ...
        <div class='sidebar span_4 last'>
            <?php foreach ($sidebarSections as $sidebarSection) : ?>
                  ...
                  <?php elseif($sidebarSection['acf_fc_layout'] == "section"): ?>
                      ...
                      <div class='sidebar-item <?php echo $firstSidebarItem == true ? " first " : ""; ?>'>
...
<g id="americas" class='<?php echo $selectedRegion == "america" ? "selected" : ""; ?>'>
	<g>
		...
		<rect x="601.3" y="260.7" fill="#8F9094" width="2.9" height="2.9"/>
			...
			<rect class='office' id="kaysville" x="639.6" y="285.6" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 1299.7224 37.7012)" fill="#EA0F43" width="4.9" height="4.9"/>
			...
			<rect class='office' id="victoria" x="607.9" y="267.4" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 1232.7037 29.136)" fill="#EA0F43" width="4.9" height="4.9"/>
			...
			<rect class='office' id="sanDiego" x="627.1" y="313.3" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 1297.9932 93.8163)" fill="#EA0F43" width="4.9" height="4.9"/>
...
<g id='apac'  class='<?php echo $selectedRegion == "apac" ? "selected" : ""; ?>'>
	...
	<g>
		...
		<rect x="1048.7" y="425.2" fill="#0E31A0" width="2.9" height="2.9"/>
			...
			<rect class='office' id="beijing" x="1025.9" y="294.7" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 1965.4995 -219.9365)" fill="#EA0F43" width="4.9" height="4.9"/>
