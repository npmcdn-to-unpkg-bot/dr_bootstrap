 ...
 * Bootstrap Files
 */
wp_register_script( 'bootstrap-js', get_template_directory_uri() . '/bootstrap/dist/js/bootstrap.min.js', array( 'jquery' ), '3.0.1', true );

wp_register_style( 'bootstrap-css', get_template_directory_uri() . '/bootstrap/dist/css/bootstrap.min.css', array(), '3.0.1', 'all' );
