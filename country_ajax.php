...
class Country {
  ...
  if($id != "North America" && $id != "Europe" && $id != "Asia" && $id != "Asia Pacific" && $id != "South America" && $id != "Africa"){
    ...
    foreach($this->globalCard as $card){
      ...
      $this->countries[$this->countryId]['value'][2] = $this->countries[$this->countryId][2];
      $this->countries[$this->countryId]['value'][3] = $this->countries[$this->countryId][3];
      $this->countries[$this->countryId]['value'][4] = $this->countries[$this->countryId][4];
      $this->countries[$this->countryId]['value'][5] = $this->countries[$this->countryId][5];
...
echo "<div id='mapOverlay' >";
  ...
  if($id == 38){
    ...
    if($countryImg):
        echo '<img class=" country-img" style="text-align:center; max-width:90%; max-height:90%;  margin: 0 auto 30px; display: block;" src="/wp-content/themes/digital-river-translated/img/interactive/countries/'.$countryImg.'.svg" />';
    endif;
