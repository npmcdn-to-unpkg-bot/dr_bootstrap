...
<div class="example">
	...
	<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;h1</span> <span class="na">class=</span><span class="s">"eng"</span><span class="nt">&gt;</span></span>DIN Engschrift Heading<span class="nt">&lt;/h1&gt;</span>
...
<div class="example">
			...
			<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;h1&gt;</span>h1 Heading<span class="nt">&lt;/h1&gt;</span>    <span class="nt">&lt;h1</span> <span class="na">class=</span><span class="s">"h6"</span><span class="nt">&gt;</span>h1 Heading <span class="nt">&lt;small&gt;</span>with h6 class<span class="nt">&lt;/small&gt;&lt;/h1&gt;</span>
...
<div class="example">
			...
			<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;h1&gt;</span>h1 Heading <span class="nt">&lt;small&gt;</span>Secondary text<span class="nt">&lt;/small&gt;&lt;/h1&gt;</span>
...
<?php
        ...
        <div class="example">
			...
			<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p&gt;</span>...<span class="nt">&lt;/p&gt;</span>
</code></pre></figure>
		</div>
...
<!-- 		        <h3 id="lead-body-copy"><a class="anchorjs-link " href="#lead-body-copy" aria-label="Anchor link for: lead body copy" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Lead body copy</h3>
        ...
        <div class="example">
			...
			<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"lead"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/p&gt;</span></code></pre></figure>
		</div>
 -->
...
<!-- 
        ...
        <div class="example">
			...
			<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html">You can use the mark tag to <span class="nt">&lt;mark&gt;</span>highlight<span class="nt">&lt;/mark&gt;</span> text.</code></pre></figure>
		</div>
		       ...
		       <div class="example">
					...
					<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;del&gt;</span>This line of text is meant to be treated as deleted text.<span class="nt">&lt;/del&gt;</span>
<span class="nt">&lt;s&gt;</span>This line of text is meant to be treated as no longer accurate.<span class="nt">&lt;/s&gt;</span></code></pre></figure>
		        ...
		        <p>Use the <code>&lt;ins&gt;</code> tag to indicate additions to the document. Use the <code>&lt;u&gt;</code> tag to underline text </p>
   				...
   				<div class="example">
					...
					<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ins&gt;</span>This line of text is meant to be treated as an addition to the document.<span class="nt">&lt;/ins&gt;</span>
...
<span class="nt">&lt;small&gt;</span>* This line of text is meant to be treated as fine print.<span class="nt">&lt;/small&gt;</span></code></pre></figure>
		        ...
		        <p>For emphasizing a snippet of text with a heavier font-weight.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <p>The following snippet of text is <strong>rendered as bold text</strong>.</p>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html">The following snippet of text is <span class="nt">&lt;strong&gt;</span>rendered as bold text<span class="nt">&lt;/strong&gt;</span>.</code></pre></figure>
</div>
		        ...
		        <p>For emphasizing a snippet of text with italics.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <p>The following snippet of text is <em>rendered as italicized text</em>.</p>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html">The following snippet of text is <span class="nt">&lt;em&gt;</span>rendered as italicized text<span class="nt">&lt;/em&gt;</span>.</code></pre></figure>
</div>
		        ...
		        <p>Easily realign text to components with text alignment classes.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <p class="text-left">Left aligned text.</p>
		            <p class="text-center">Center aligned text.</p>
		            <p class="text-right">Right aligned text.</p>
		            <p class="text-justify">Justified text.</p>
		            <p class="text-nowrap">Ahhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh!</p>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"text-left"</span><span class="nt">&gt;</span>Left aligned text.<span class="nt">&lt;/p&gt;</span>
...
<span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"text-nowrap"</span><span class="nt">&gt;</span>Ahhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh!<span class="nt">&lt;/p&gt;</span></code></pre></figure>
</div>
...
<?php
        ...
        ?>
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <p class="text-lowercase">Lowercased text.</p>
		            <p class="text-uppercase">Uppercased text.</p>
		            <p class="text-capitalize">Capitalized text.</p>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"text-lowercase"</span><span class="nt">&gt;</span>Lowercased text.<span class="nt">&lt;/p&gt;</span>
...
<?php
        ...
        ?>
		        ...
		        <h3 id="basic-abbreviation"><a class="anchorjs-link " href="#basic-abbreviation" aria-label="Anchor link for: basic abbreviation" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Basic abbreviation</h3>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <p>An abbreviation of the word attribute is <abbr title="attribute">attr</abbr>.</p>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html">An abbreviation of the word attribute is <span class="nt">&lt;abbr</span> <span class="na">title=</span><span class="s">"attribute"</span><span class="nt">&gt;</span>attr<span class="nt">&lt;/abbr&gt;</span>.</code></pre></figure>
</div>
		        ...
		        <p>Add <code>.initialism</code> to an abbreviation for a slightly smaller font-size.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <p><abbr title="HyperText Markup Language" class="initialism">HTML</abbr> is the best thing since sliced bread.</p>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;abbr</span> <span class="na">title=</span><span class="s">"HyperText Markup Language"</span> <span class="na">class=</span><span class="s">"initialism"</span><span class="nt">&gt;</span>HTML<span class="nt">&lt;/abbr&gt;</span> is the best thing since sliced bread.</code></pre></figure>
</div>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;address&gt;</span>
...
<?php
        ...
        ?>
		        ...
		        <p>Wrap <code>&lt;blockquote&gt;</code> around any <abbr title="HyperText Markup Language">HTML</abbr> as the quote. For straight quotes, we recommend a <code>&lt;p&gt;</code>.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <blockquote>
		                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
		            </blockquote>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;blockquote&gt;</span>
...
<span class="nt">&lt;/blockquote&gt;</span></code></pre></figure>
		        ...
		        <p>Add <code>.blockquote-reverse</code> for a blockquote with right-aligned content.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <blockquote class="blockquote-reverse">
		                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
		                <footer>Someone famous in <cite title="Source Title">Source Title</cite></footer>
		            </blockquote>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;blockquote</span> <span class="na">class=</span><span class="s">"blockquote-reverse"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/blockquote&gt;</span></code></pre></figure>
</div>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul <span class="na">class=</span><span class="s">"bullet-list"</span><span class="nt">&gt;</span></span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ol&gt;</span>
  <span class="nt">&lt;li&gt;</span>...<span class="nt">&lt;/li&gt;</span>
...
<!-- 
		        ...
		        <p>Remove the default <code>list-style</code> and left margin on list items (immediate children only). <strong>This only applies to immediate children list items</strong>, meaning you will need to add the class for any nested lists as well.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <ul class="list-unstyled">
		                <li>Lorem ipsum dolor sit amet</li>
		                <li>Consectetur adipiscing elit</li>
		                <li>Integer molestie lorem at massa</li>
		                <li>Facilisis in pretium nisl aliquet</li>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"list-unstyled"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;li&gt;</span>...<span class="nt">&lt;/li&gt;</span>
<span class="nt">&lt;/ul&gt;</span></code></pre></figure>
</div> -->
		        ...
		        <p>Place all list items on a single line with <code>display: inline-block;</code> and some light padding.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <ul class="list-inline">
		                <li>Lorem ipsum</li>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"list-inline"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;li&gt;</span>...<span class="nt">&lt;/li&gt;</span>
<span class="nt">&lt;/ul&gt;</span></code></pre></figure>
</div>
<!-- 
		        ...
		        <p>A list of terms with their associated descriptions.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <dl> <dt>Description lists</dt>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;dl&gt;</span>
...
<span class="nt">&lt;/dl&gt;</span></code></pre></figure>
		        ...
		        <p>Make terms and descriptions in <code>&lt;dl&gt;</code> line up side-by-side. Starts off stacked like default <code>&lt;dl&gt;</code>s, but when the navbar expands, so do these.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <dl class="dl-horizontal"> <dt>Description lists</dt>
		                <dd>A description list is perfect for defining terms.</dd> <dt>Euismod</dt>
		                <dd>Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit.</dd>
		                <dd>Donec id elit non mi porta gravida at eget metus.</dd> <dt>Malesuada porta</dt>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;dl</span> <span class="na">class=</span><span class="s">"dl-horizontal"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;dt&gt;</span>...<span class="nt">&lt;/dt&gt;</span>
  <span class="nt">&lt;dd&gt;</span>...<span class="nt">&lt;/dd&gt;</span>
<span class="nt">&lt;/dl&gt;</span></code></pre></figure>
</div>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html">This <span class="nt">&lt;code&gt;</span><span class="ni">&amp;lt;</span>section<span class="ni">&amp;gt;</span><span class="nt">&lt;/code&gt;</span> tag is displayed as inline code, and was written with HTML entities.</code></pre></figure>
</div>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html">To switch directories, type <span class="nt">&lt;kbd&gt;</span>cd<span class="nt">&lt;/kbd&gt;</span> followed by the name of the directory.<span class="nt">&lt;br&gt;</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;pre&gt;</span><span class="ni">&amp;lt;</span>p<span class="ni">&amp;gt;</span>Sample text here...<span class="ni">&amp;lt;</span>/p<span class="ni">&amp;gt;</span><span class="nt">&lt;/pre&gt;</span></code></pre></figure>
</div>
...
<!-- 		        <p>For indicating variables use the <code>&lt;var&gt;</code> tag.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <p><var>y</var> = <var>m</var><var>x</var> + <var>b</var></p>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;var&gt;</span>y<span class="nt">&lt;/var&gt;</span> = <span class="nt">&lt;var&gt;</span>m<span class="nt">&lt;/var&gt;&lt;var&gt;</span>x<span class="nt">&lt;/var&gt;</span> + <span class="nt">&lt;var&gt;</span>b<span class="nt">&lt;/var&gt;</span></code></pre></figure>
</div>
 -->
...
<?php
        ...
        ?>
		        <p>For indicating blocks sample output from a program use the <code>&lt;samp&gt;</code> tag.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <p><samp>This text is meant to be treated as sample output from a computer program.</samp></p>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;samp&gt;</span>This text is meant to be treated as sample output from a computer program.<span class="nt">&lt;/samp&gt;</span></code></pre></figure>
</div>
...
<?php
        ...
        ?>
		        <p>For basic styling—light padding and only horizontal dividers—add the base class <code>.table</code> to any <code>&lt;table&gt;</code>. It may seem super redundant, but given the widespread use of tables for other plugins like calendars and date pickers, we've opted to isolate our custom table styles.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <table class="table">
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table"</span><span class="nt">&gt;</span>
  ...
...
<span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table"</span><span class="nt">&gt;</span>
   <span class="nt">&lt;thead</span> <span class="na">class=</span><span class="s">"bd-red"</span><span class="nt">&gt;</span>
      ...
   <span class="nt">&lt;/thead&gt;</span>
   ... 
<span class="nt">&lt;/table&gt;</span>
...
<span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table"</span><span class="nt">&gt;</span>
   <span class="nt">&lt;thead</span> <span class="na">class=</span><span class="s">"bd-blue"</span><span class="nt">&gt;</span>
      ...
   <span class="nt">&lt;/thead&gt;</span>
   ... 
<span class="nt">&lt;/table&gt;</span>
...
<span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table"</span><span class="nt">&gt;</span>
   <span class="nt">&lt;thead</span> <span class="na">class=</span><span class="s">"bd-gray"</span><span class="nt">&gt;</span>
      ...
   <span class="nt">&lt;/thead&gt;</span>
   ... 
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
...
<?php
        ...
        ?>
		        <div class="dr-callout dr-callout-danger icon" id="callout-tables-striped-ie8">
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <table class="table table-striped">
		                <thead>
		                    <tr>
		                        <th>#</th>
		                        <th>First Name</th>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table table-striped"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
</div>
        ...
        ?>
		        <p>Add <code>.table-bordered</code> for borders on all sides of the table and cells.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <table class="table table-bordered">
		                <thead>
		                    <tr>
		                        <th>#</th>
		                        <th>First Name</th>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table table-bordered"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
</div>
        ...
        ?>
		        <p>Add <code>.table-hover</code> to enable a hover state on table rows within a <code>&lt;tbody&gt;</code>.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <table class="table table-hover">
		                <thead>
		                    <tr>
		                        <th>#</th>
		                        <th>First Name</th>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table table-hover"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
</div>
...
<!-- 		        <p>Add <code>.table-condensed</code> to make tables more compact by cutting cell padding in half.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <table class="table table-condensed">
		                <thead>
		                    <tr>
		                        <th>#</th>
		                        <th>First Name</th>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table table-condensed"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
</div>
 -->
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- On rows --&gt;</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-css" data-lang="css"><span class="k">@-moz-document</span> <span class="n">url-prefix</span><span class="p">()</span> <span class="p">{</span>
...
<span class="p">}</span></code></pre></figure>
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <div class="table-responsive">
		                <table class="table">
		                    <thead>
		                        <tr>
		                            <th>#</th>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"table-responsive"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table"</span><span class="nt">&gt;</span>
    ...
  <span class="nt">&lt;/table&gt;</span>
<span class="nt">&lt;/div&gt;</span></code></pre></figure>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;form&gt;</span>
...
<span class="nt">&lt;/form&gt;</span></code></pre></figure>
		        ...
		        <div class="dr-callout dr-callout-warning icon" id="callout-inline-form-labels">
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form class="form-inline">
		                <div class="form-group">
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;form</span> <span class="na">class=</span><span class="s">"form-inline"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/form&gt;</span></code></pre></figure>
        ...
        ?>
		        <p>Use Bootstrap's predefined grid classes to align labels and groups of form controls in a horizontal layout by adding <code>.form-horizontal</code> to the form (which doesn't have to be a <code>&lt;form&gt;</code>). Doing so changes <code>.form-group</code>s to behave as grid rows, so no need for <code>.row</code>.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form class="form-horizontal">
		                <div class="form-group">
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;form</span> <span class="na">class=</span><span class="s">"form-horizontal"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/form&gt;</span></code></pre></figure>
        ...
        ?>
		        ...
		        <div class="dr-callout dr-callout-danger icon" id="callout-input-needs-type">
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="2">
		                <input type="text" class="form-control" placeholder="Text input"> </form>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;input</span> <span class="na">type=</span><span class="s">"text"</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="na">placeholder=</span><span class="s">"Text input"</span><span class="nt">&gt;</span></code></pre></figure>
</div>
		        ...
		        <p>Form control which supports multiple lines of text. Change <code>rows</code> attribute as necessary.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="3">
		                <textarea class="form-control" rows="3" placeholder="Textarea"></textarea>
		            </form>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;textarea</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="na">rows=</span><span class="s">"3"</span><span class="nt">&gt;&lt;/textarea&gt;</span></code></pre></figure>
</div>
		        ...
		        <h4 id="default-stacked"><a class="anchorjs-link " href="#default-stacked" aria-label="Anchor link for: default stacked" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Default (stacked)</h4>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="4">
		                <div class="checkbox">
		                    <label>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"checkbox"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;label&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></figure>
		        ...
		        <p>Use the <code>.checkbox-inline</code> or <code>.radio-inline</code> classes on a series of checkboxes or radios for controls that appear on the same line.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="5">
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;label</span> <span class="na">class=</span><span class="s">"checkbox-inline"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/label&gt;</span></code></pre></figure>
		        ...
		        <p>Should you have no text within the <code>&lt;label&gt;</code>, the input is positioned as you'd expect. <strong>Currently only works on non-inline checkboxes and radios.</strong> Remember to still provide some form of label for assistive technologies (for instance, using <code>aria-label</code>).</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="7">
		                <div class="checkbox">
		                    <label>
...
<span class="nt">&lt;/div&gt;</span></code></pre></figure>
		        ...
		        <p>Note that many native select menus—namely in Safari and Chrome—have rounded corners that cannot be modified via <code>border-radius</code> properties.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="8">
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;select</span> <span class="na">class=</span><span class="s">"form-control"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/select&gt;</span></code></pre></figure>
		        ...
		        <p>For <code>&lt;select&gt;</code> controls with the <code>multiple</code> attribute, multiple options are shown by default.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;select</span> <span class="na">multiple</span> <span class="na">class=</span><span class="s">"form-control"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;option&gt;</span>1<span class="nt">&lt;/option&gt;</span>
  <span class="nt">&lt;option&gt;</span>2<span class="nt">&lt;/option&gt;</span>
  <span class="nt">&lt;option&gt;</span>3<span class="nt">&lt;/option&gt;</span>
  <span class="nt">&lt;option&gt;</span>4<span class="nt">&lt;/option&gt;</span>
...
<span class="nt">&lt;/form&gt;</span></code></pre></figure>
        ...
        ?>
		        <p>We remove the default <code>outline</code> styles on some form controls and apply a <code>box-shadow</code> in its place for <code>:focus</code>.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="9">
		        ...
		        <p>Add the <code>disabled</code> boolean attribute on an input to prevent user interactions. Disabled inputs appear lighter and add a <code>not-allowed</code> cursor.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="10">
		                <input class="form-control" id="disabledInput" type="text" placeholder="Disabled input here…" disabled="disabled"> </form>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;input</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="na">id=</span><span class="s">"disabledInput"</span> <span class="na">type=</span><span class="s">"text"</span> <span class="na">placeholder=</span><span class="s">"Disabled input here..."</span> <span class="na">disabled</span><span class="nt">&gt;</span></code></pre></figure>
</div>
		        ...
		        <div class="dr-callout dr-callout-danger icon" id="callout-fieldset-disabled-ie">
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="11">
...
<span class="nt">&lt;/form&gt;</span></code></pre></figure>
        ...
        ?>
		        <p>Add the <code>readonly</code> boolean attribute on an input to prevent modification of the input's value. Read-only inputs appear lighter (just like disabled inputs), but retain the standard cursor.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="12">
		                <input class="form-control" type="text" placeholder="Readonly input here…" readonly="readonly"> </form>
		        </div>
		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;input</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="na">type=</span><span class="s">"text"</span> <span class="na">placeholder=</span><span class="s">"Readonly input here…"</span> <span class="na">readonly</span><span class="nt">&gt;</span></code></pre></figure>
</div>
        ...
        ?>
		        ...
		        <div class="dr-callout dr-callout-info icon" id="callout-help-text-accessibility">
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <form lpformnum="13">
		                <div class="form-group">
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;label</span> <span class="na">class=</span><span class="s">"sr-only"</span> <span class="na">for=</span><span class="s">"inputHelpBlock"</span><span class="nt">&gt;</span>Input with help text<span class="nt">&lt;/label&gt;</span>
        ...
        ?>
		    ...
		    <div class="dr-callout dr-callout-warning icon" id="callout-form-validation-state-accessibility">
		        ...
		        <p>Ensure that an alternative indication of state is also provided. For instance, you can include a hint about state in the form control's <code>&lt;label&gt;</code> text itself (as is the case in the following code example), include a <a href="../components/#glyphicons">Glyphicon</a> (with appropriate alternative text using the <code>.sr-only</code> class - see the <a href="../components/#glyphicons-examples">Glyphicon examples</a>), or by providing an additional <a href="#forms-help-text">help text</a> block. Specifically for assistive technologies, invalid form controls can also be assigned an <code>aria-invalid="true"</code> attribute.</p>
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		        <form lpformnum="14">
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group has-success"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></figure>
		    ...
		    <div class="dr-callout dr-callout-warning icon" id="callout-has-feedback-icon-accessibility">
		        ...
		        <p>Although the following examples already mention the validation state of their respective form controls in the <code>&lt;label&gt;</code> text itself, the above technique (using <code>.sr-only</code> text and <code>aria-describedby</code>) has been included for illustrative purposes.</p>
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		        <form lpformnum="15">
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group has-success has-feedback"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/form&gt;</span></code></pre></figure>
		    ...
		    <p>If you use the <code>.sr-only</code> class to hide a form control's <code>&lt;label&gt;</code> (rather than using other labelling options, such as the <code>aria-label</code> attribute), Bootstrap will automatically adjust the position of the icon once it's been added.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		        <div class="form-group has-success has-feedback">
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;input</span> <span class="na">class=</span><span class="s">"form-control input-lg"</span> <span class="na">type=</span><span class="s">"text"</span> <span class="na">placeholder=</span><span class="s">".input-lg"</span><span class="nt">&gt;</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"row"</span><span class="nt">&gt;</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"text-muted"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/p&gt;</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"bg-primary"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/p&gt;</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"close"</span> <span class="na">aria-label=</span><span class="s">"Close"</span><span class="nt">&gt;&lt;span</span> <span class="na">aria-hidden=</span><span class="s">"true"</span><span class="nt">&gt;</span><span class="ni">&amp;times;</span><span class="nt">&lt;/span&gt;&lt;/button&gt;</span></code></pre></figure>
		        ...
		        <p>Use carets to indicate dropdown functionality and direction. Note that the default caret will reverse automatically in <a href="../components/#btn-dropdowns-dropup">dropup menus</a>.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label></div>		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"caret"</span><span class="nt">&gt;&lt;/span&gt;</span></code></pre></figure>
</div>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"pull-left"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-scss" data-lang="scss"><span class="c1">// Classes</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"center-block"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre></figure>

		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-scss" data-lang="scss"><span class="c1">// Class</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- Usage as a class --&gt;</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-scss" data-lang="scss"><span class="c1">// Mixin itself</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"show"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;a</span> <span class="na">class=</span><span class="s">"sr-only sr-only-focusable"</span> <span class="na">href=</span><span class="s">"#content"</span><span class="nt">&gt;</span>Skip to main content<span class="nt">&lt;/a&gt;</span></code></pre></figure>

		        
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-scss" data-lang="scss"><span class="c1">// Usage as a mixin</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;h1</span> <span class="na">class=</span><span class="s">"text-hide"</span><span class="nt">&gt;</span>Custom heading<span class="nt">&lt;/h1&gt;</span></code></pre></figure>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;img</span> <span class="na">src=</span><span class="s">"..."</span> <span class="na">class=</span><span class="s">"img-responsive"</span> <span class="na">alt=</span><span class="s">"Responsive image"</span><span class="nt">&gt;</span></code></pre></figure>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;img</span> <span class="na">src=</span><span class="s">"..."</span> <span class="na">alt=</span><span class="s">"..."</span> <span class="na">class=</span><span class="s">"img-rounded"</span><span class="nt">&gt;</span>
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;a</span> <span class="na">class=</span><span class="s">"btn btn-default"</span> <span class="na">href=</span><span class="s">"#"</span> <span class="na">role=</span><span class="s">"button"</span><span class="nt">&gt;</span>Link<span class="nt">&lt;/a&gt;</span>
					...
					<div class="top">
						...
						<p>
		           		...
		           		<div class="row text-center">
			           		<div class="col-md-3" >
			           			<div class="bg-blue">
			           				<button type="button" class="btn btn-opposite option margin-top margin-bottom">Opposite</button>
			           			</div>
			           		</div>
			           		<div class="col-md-3" >
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- Standard button --&gt;</span>
...
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"bg-yellow"</span><span class="nt">&gt;</span>
   <span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"btn btn-opposite"</span><span class="nt">&gt;</span>Opposite<span class="nt">&lt;/button&gt;</span>
<span class="nt">&lt;div&gt;</span> 

<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"bg-gray"</span><span class="nt">&gt;</span>
   <span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"btn btn-opposite"</span><span class="nt">&gt;</span>Opposite<span class="nt">&lt;/button&gt;</span>
<span class="nt">&lt;div&gt;</span> 
...
<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p&gt;</span>
...
<span class="nt">&lt;/p&gt;</span> -->
		        ...
		        <p>Create block level buttons—those that span the full width of a parent— by adding <code>.btn-block</code>.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <div class="well center-block" style="max-width:400px">
...
?>
   <div class="section-body">
		        ...
		        <p>Separators are automatically added in CSS through <code>:before</code> and <code>content</code>.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <ol class="breadcrumb">
        ...
        <figure class="highlight"><label class="example-label">HTML</label><pre>
...
$this->displayHeader(
   ...
   <div class="section-body">
		        ...
		        <p>Simple pagination inspired by Rdio, great for apps and search results. The large block is hard to miss, easily scalable, and provides large click areas.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <nav>
		                <ul class="pagination">
		                    <li>
        ...
        <figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;nav&gt;</span>
   ...
   <div class="section-body">
		    ...
		    <!--     <h2 id="alerts-examples"><a class="anchorjs-link " href="#alerts-examples" aria-label="Anchor link for: alerts examples" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Examples</h2>
		        ...
		        <div class="dr-callout dr-callout-info icon" id="callout-alerts-no-default">
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <div class="alert alert-success" role="alert"> <strong>Well done!</strong> You successfully read this important alert message. </div>
        ...
        <figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"alert alert-success"</span> <span class="na">role=</span><span class="s">"alert"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span>
...
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"alert alert-danger"</span> <span class="na">role=</span><span class="s">"alert"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre></figure>
		        ...
		        <div class="dr-callout dr-callout-info icon" id="callout-alerts-dismiss-plugin">
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <div class="alert alert-warning alert-dismissible" role="alert">
        ...
        <figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"alert alert-warning alert-dismissible"</span> <span class="na">role=</span><span class="s">"alert"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></figure>
		        ...
		        <p>Use the <code>.alert-link</code> utility class to quickly provide matching colored links within any alert.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <div class="alert alert-success" role="alert"> <strong>Well done!</strong> You successfully read <a href="#" class="alert-link">this important alert message</a>. </div>
        ...
        <figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"alert alert-success"</span> <span class="na">role=</span><span class="s">"alert"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></figure>
 ...
 -->
	        ...
	        <p>Callout alerts are for this identifying important (and not so important) notes related to a given topic. Choose from success, info, warning, or danger.</p>
	          ...
	          <figure class="highlight"><label class="example-label">HTML</label>
	          	<pre>
...
<!-- 		        <h2 id="panels-basic"><a class="anchorjs-link " href="#panels-basic" aria-label="Anchor link for: panels basic" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Basic example</h2>
		        <p>By default, all the <code>.panel</code> does is apply some basic border and padding to contain some content.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <div class="panel panel-default">
		                <div class="panel-body"> Basic panel example </div>
		            </div>
		        </div>
		        
        <figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"panel panel-default"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></figure>
	...
	?>
		        <p>Like other components, easily make a panel more meaningful to a particular context by adding any of the contextual state classes.</p>
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		            <div class="panel panel-primary">
		                <div class="panel-heading">
		                    <h3 class="panel-title">Panel title</h3> </div>
		                <div class="panel-body"> Panel content </div>
		            </div>
        ...
        <figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"panel panel-primary"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span>
...
<div class="section-body">
    ...
    <div class="dr-callout dr-callout-danger icon" id="callout-buttons-disabled-anchor">
        ...
        <p>Bootstrap's jQuery File is required when using tabs.</p>
   				...
   				<div class="example">
					<div class="top">
						<label class="example-label">Example</label>		<ul class="nav nav-tabs">
	...
	<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"nav nav-tabs"</span><span class="nt">&gt;</span>
...
<div class="section-body" id="dr-docs-colors">
	...
	<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;h1</span> <span class="na">class=</span><span class="s">"txt-blue"</span><span class="nt">&gt;</span>Blue text.<span class="nt">&lt;/h1&gt;</span>
...
<span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"txt-purple"</span><span class="nt">&gt;</span>Purple text.<span class="nt">&lt;/p&gt;</span></code></pre></figure>
	...
	<div class="background-colors">
		...
		<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"bg-blue"</span><span class="nt">&gt;</span>
   ...
   <div class="section-body">
	...
	?>
		...
		<div class="example">
			...
			<figure class="highlight"><label class="example-label">Code</label><pre><code class="language-json" data-lang="json"> ... </code></pre></figure>
		</div>
		</div>
		<figure class="highlight"><label class="example-label">HTML</label><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"example"</span><span class="nt">&gt;</span>
		...
		<div class="tab-content">
			<div id="json" class="tab-pane active">
				<div class="example">
					...
					<figure class="highlight"><label class="example-label">Response</label><pre><code class="language-json" data-lang="json"> {} </code></pre></figure>
				</div>
			</div>
			<div id="xml" class="tab-pane">
				...
				<figure class="highlight"><label class="example-label">Response</label><pre><code class="language-xml" data-lang="xml"><span class="nt">&lt;?xml</span> <span class="na">version=</span><span class="s">"1.0"</span> <span class="nt">?&gt;</span>
